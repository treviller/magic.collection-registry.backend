CREATE TYPE set_type AS ENUM ('core', 'expansion', 'masters', 'masterpiece', 'arsenal', 'from_the_vault', 'spellbook',
'premium_deck', 'duel_deck', 'draft_innovation', 'commander', 'planechase', 'archenemy', 'vanguard', 'funny', 'starter',
